...
from my_hw_interface.msg import degree_msg
...
rev_data = degree_msg()
total_data = degree_msg()
total_data_prev = degree_msg()
...
def callBackFunc(message):
	...
	rev_data.joint1 = int((message.joint1 * 180) / PI)
	rev_data.joint2 = int((message.joint2 * 180) / PI)
	rev_data.joint3 = int((message.joint3 * 180) / PI)
	rev_data.joint4 = int((message.joint4 * 180) / PI)
	rev_data.joint5 = int((message.joint5 * 180) / PI)
...
publisher1 = rospy.Publisher(topicName, degree_msg, queue_size = 1)
